---
name: lumora
description: Build or redesign complete premium websites with "$lumora" or "Lumora" from exact loaded MotionSites prompt_text entries. Use for websites, landing pages, heroes, SaaS, agency, portfolio, ecommerce, waitlist, signup, or rich frontend builds. Must scrape first, preserve multipage sources, obey every Lumora rule without bypass, ban arceage-contact-us and agency-services, use original source hero/logo media, prepare fitting card media, keep prompt design/layout/motion 1:1, and verify manifest, media, responsiveness, links, and prompt fidelity.
---
